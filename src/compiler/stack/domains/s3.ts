...
export function synthesizeS3(ctx: CompilationContext): void {
  ...
  for (const [name, bucket] of Object.entries(config.storage.s3)) {
    ...
    refs[name] = new s3.Bucket(stack, `Bucket${name}`, {
